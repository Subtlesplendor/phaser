...
pub const ResultType = potential.ResultType;
pub const Provenance = potential.Provenance;
pub const Selection = potential.Selection;
pub const LoopTotal = potential.LoopTotal;
...
pub const deriveEffectivePotential = potential.deriveEffectivePotential;
pub const deriveClassicalPotential = potential.deriveClassicalPotential;
pub const scalar_mass_dimension = potential.scalar_mass_dimension;
pub const potential_mass_dimension = potential.potential_mass_dimension;
pub const scale_name = potential.scale_name;
